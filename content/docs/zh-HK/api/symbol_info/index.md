...
**類型:** <code>simple&nbsp;<a class="stdlib-ref" href="/zh-HK/api/prelude/Session">Session</a></code>
...
| 名稱 | 類型 | 預設值 | 說明 |
| --- | --- | --- | --- |
| `symbol` | <code><a class="stdlib-ref" href="/zh-HK/api/prelude/String">String</a></code> |  | 從中獲取前綴的交易品種代碼字符串。 |
...
| 名稱 | 類型 | 預設值 | 說明 |
| --- | --- | --- | --- |
| `symbol` | <code><a class="stdlib-ref" href="/zh-HK/api/prelude/String">String</a></code> |  | 從中獲取名稱的交易品種股票字符串。 |
