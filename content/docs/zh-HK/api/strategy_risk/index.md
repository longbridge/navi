...
| 名稱 | 類型 | 預設值 | 說明 |
| --- | --- | --- | --- |
| `dir` | <code>simple&nbsp;<a class="stdlib-ref" href="/zh-HK/api/prelude/Direction">Direction</a></code> |  |  |
...
| `type` | <code>simple&nbsp;<a class="stdlib-ref" href="/zh-HK/api/prelude/DefaultQtyType">DefaultQtyType</a></code> |  | 值類型：`strategy.cash` 或 `strategy.percent_of_equity`。 |
