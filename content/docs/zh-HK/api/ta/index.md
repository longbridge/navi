...
| 名稱 | 說明 |
| --- | --- |
| [`PivotType`](/zh-HK/api/ta/PivotType) | Pivot point calculation method for <a class="stdlib-ref" data-key="ta::pivot_point_levels" href="/zh-HK/api/ta/#pivot_point_levels">ta.pivot_point_levels</a>. |
...
| 名稱 | 類型 | 預設值 | 說明 |
| --- | --- | --- | --- |
| `type` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-HK/api/ta/PivotType">PivotType</a></code> |  | The pivot calculation method. |
| `change` | <code>series&nbsp;bool</code> |  | `true` on the first bar of a new pivot period. |

**返回:** <code>series&nbsp;<a class="stdlib-ref" href="/zh-HK/api/prelude/Array">Array</a>&lt;float&gt;</code>
