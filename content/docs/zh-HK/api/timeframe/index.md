...
**類型:** <code>simple&nbsp;<a class="stdlib-ref" href="/zh-HK/api/prelude/String">String</a></code>
...
| 名稱        | 類型                                                                           | 預設值 | 說明 |
| ----------- | ------------------------------------------------------------------------------ | ------ | ---- |
| `timeframe` | <code><a class="stdlib-ref" href="/zh-HK/api/prelude/String">String</a></code> |        |      |
...
**返回:** <code><a class="stdlib-ref" href="/zh-HK/api/prelude/String">String</a></code> — 時間範圍字符串（例如，3600 傳回“60”，86400 傳回“D”）。
...
| 名稱        | 類型                                                                           | 預設值             | 說明                                           |
| ----------- | ------------------------------------------------------------------------------ | ------------------ | ---------------------------------------------- |
| `timeframe` | <code><a class="stdlib-ref" href="/zh-HK/api/prelude/String">String</a></code> | `timeframe.period` | 要轉換的時間範圍字符串。默認為圖表的時間範圍。 |
