...
傳回指定 bar 索引和價格處的 <a class="stdlib-ref" data-key="chart::Point" href="/zh-HK/api/chart/Point">chart.Point</a> 物件。
...
**返回:** <code><a class="stdlib-ref" href="/zh-HK/api/chart/Point">Point</a></code>
