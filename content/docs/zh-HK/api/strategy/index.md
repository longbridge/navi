...
**類型:** <code>series&nbsp;<a class="stdlib-ref" href="/zh-HK/api/prelude/String">String</a></code>

傳回用於策略賬户的貨幣代碼，如 <a class="stdlib-ref" data-key="prelude::strategy" href="/zh-HK/api/prelude/#strategy">strategy</a> 聲明中所設定。
...
傳回用於市價訂單的默認合約/股票/手數/單位數量。根據 <a class="stdlib-ref" data-key="prelude::strategy" href="/zh-HK/api/prelude/#strategy">strategy</a> 聲明的 `default_qty_type` 和 `default_qty_value` 參數計算。價值取決於當前價格和淨值。
...
傳回 <a class="stdlib-ref" data-key="prelude::strategy" href="/zh-HK/api/prelude/#strategy">strategy</a> 聲明中設定的初始大寫字母。這是回測的起始現金，由 `initial_capital` 參數指定。
...
| 名稱 | 類型                                                                                       | 預設值 | 說明                 |
| ---- | ------------------------------------------------------------------------------------------ | ------ | -------------------- |
| `id` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-HK/api/prelude/String">String</a></code> |        | 要取消的訂單標識符。 |
...
| 名稱            | 類型                                                                                       | 預設值  | 說明                          |
| --------------- | ------------------------------------------------------------------------------------------ | ------- | ----------------------------- |
| `id`            | <code>series&nbsp;<a class="stdlib-ref" href="/zh-HK/api/prelude/String">String</a></code> |         | 要關閉的條目 ID。             |
| `comment`       | <code>series&nbsp;<a class="stdlib-ref" href="/zh-HK/api/prelude/String">String</a></code> | `na`    | 生成的平倉訂單的可選註釋。    |
| `qty`           | <code>series&nbsp;float</code>                                                             | `na`    | 絕對數量關閉。                |
| `qty_percent`   | <code>series&nbsp;float</code>                                                             | `na`    | 平倉的百分比。                |
| `alert_message` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-HK/api/prelude/String">String</a></code> | `na`    | 可選的警報消息。              |
...
| 名稱            | 類型                                                                                             | 預設值         | 說明                                                                |
| --------------- | ------------------------------------------------------------------------------------------------ | -------------- | ------------------------------------------------------------------- |
| `id`            | <code>series&nbsp;<a class="stdlib-ref" href="/zh-HK/api/prelude/String">String</a></code>       |                | 唯一的訂單標識符。                                                  |
| `direction`     | <code>series&nbsp;<a class="stdlib-ref" href="/zh-HK/api/prelude/Direction">Direction</a></code> |                | 訂單方：<code>strategy.long</code> 或 <code>strategy.short</code>。 |
...
| `oca_name`      | <code>series&nbsp;<a class="stdlib-ref" href="/zh-HK/api/prelude/String">String</a></code>       | `na`           | 可選的“一取消全”組名稱。                                            |
| `oca_type`      | <code>series&nbsp;<a class="stdlib-ref" href="/zh-HK/api/prelude/OcaType">OcaType</a></code>     | `OcaType.None` | OCA 行為，例如 `oca.cancel`、`oca.reduce` 或 `oca.none`。           |
| `comment`       | <code>series&nbsp;<a class="stdlib-ref" href="/zh-HK/api/prelude/String">String</a></code>       | `na`           | 可選訂單評論。                                                      |
| `alert_message` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-HK/api/prelude/String">String</a></code>       | `na`           | 此訂單的可選警報消息。                                              |
...
| 名稱               | 類型                                                                                       | 預設值  | 說明                                                |
| ------------------ | ------------------------------------------------------------------------------------------ | ------- | --------------------------------------------------- |
| `id`               | <code>series&nbsp;<a class="stdlib-ref" href="/zh-HK/api/prelude/String">String</a></code> |         | 唯一的退出指令標識符。                              |
| `from_entry`       | <code>series&nbsp;<a class="stdlib-ref" href="/zh-HK/api/prelude/String">String</a></code> | `na`    | 退出的入口 ID。當 `na` 時，退出適用於整個匹配位置。 |
...
| `oca_name`         | <code>series&nbsp;<a class="stdlib-ref" href="/zh-HK/api/prelude/String">String</a></code> | `na`    | 可選的 OCA 組名稱。                                 |
| `comment`          | <code>series&nbsp;<a class="stdlib-ref" href="/zh-HK/api/prelude/String">String</a></code> | `na`    | 從此出口填充的默認註釋。                            |
| `comment_profit`   | <code>series&nbsp;<a class="stdlib-ref" href="/zh-HK/api/prelude/String">String</a></code> | `na`    | 用於止盈填充的註釋。                                |
| `comment_loss`     | <code>series&nbsp;<a class="stdlib-ref" href="/zh-HK/api/prelude/String">String</a></code> | `na`    | 用於止損填充的註釋。                                |
| `comment_trailing` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-HK/api/prelude/String">String</a></code> | `na`    | 用於追蹤止損填充的註釋。                            |
| `alert_message`    | <code>series&nbsp;<a class="stdlib-ref" href="/zh-HK/api/prelude/String">String</a></code> | `na`    | 默認警報消息。                                      |
| `alert_profit`     | <code>series&nbsp;<a class="stdlib-ref" href="/zh-HK/api/prelude/String">String</a></code> | `na`    | 用於止盈填充的警報消息。                            |
| `alert_loss`       | <code>series&nbsp;<a class="stdlib-ref" href="/zh-HK/api/prelude/String">String</a></code> | `na`    | 用於止損填充的警報消息。                            |
| `alert_trailing`   | <code>series&nbsp;<a class="stdlib-ref" href="/zh-HK/api/prelude/String">String</a></code> | `na`    | 用於追蹤止損填充的警報消息。                        |
