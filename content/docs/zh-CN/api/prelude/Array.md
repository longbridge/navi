...
**返回:** <code><a class="stdlib-ref" href="/zh-CN/api/prelude/Array">Array</a>&lt;T&gt;</code>
...
**返回:** <code>const&nbsp;<a class="stdlib-ref" href="/zh-CN/api/prelude/Array">Array</a>&lt;T&gt;</code>
...
**返回:** <code><a class="stdlib-ref" href="/zh-CN/api/prelude/Array">Array</a>&lt;bool&gt;</code>
...
| --------------- | ------------------------------------------------------------------------ | ------ | ------------------------------------------------ |
| `size`          | <code>int</code>                                                         | `0`    | Initial size of the array. Default is 0.         |
| `initial_value` | <code><a class="stdlib-ref" href="/zh-CN/api/prelude/Box">Box</a></code> | `na`   | Initial value for all elements. Default is `na`. |

**返回:** <code><a class="stdlib-ref" href="/zh-CN/api/prelude/Array">Array</a>&lt;<a class="stdlib-ref" href="/zh-CN/api/prelude/Box">Box</a>&gt;</code>
...
| --------------- | ---------------------------------------------------------------------------- | ------ | ------------------------------------------------ |
| `size`          | <code>int</code>                                                             | `0`    | Initial size of the array. Default is 0.         |
| `initial_value` | <code><a class="stdlib-ref" href="/zh-CN/api/prelude/Color">Color</a></code> | `na`   | Initial value for all elements. Default is `na`. |

**返回:** <code><a class="stdlib-ref" href="/zh-CN/api/prelude/Array">Array</a>&lt;<a class="stdlib-ref" href="/zh-CN/api/prelude/Color">Color</a>&gt;</code>
...
**返回:** <code><a class="stdlib-ref" href="/zh-CN/api/prelude/Array">Array</a>&lt;float&gt;</code>
...
**返回:** <code><a class="stdlib-ref" href="/zh-CN/api/prelude/Array">Array</a>&lt;int&gt;</code>
...
| --------------- | ---------------------------------------------------------------------------- | ------ | ------------------------------------------------ |
| `size`          | <code>int</code>                                                             | `0`    | Initial size of the array. Default is 0.         |
| `initial_value` | <code><a class="stdlib-ref" href="/zh-CN/api/prelude/Label">Label</a></code> | `na`   | Initial value for all elements. Default is `na`. |

**返回:** <code><a class="stdlib-ref" href="/zh-CN/api/prelude/Array">Array</a>&lt;<a class="stdlib-ref" href="/zh-CN/api/prelude/Label">Label</a>&gt;</code>
...
| --------------- | -------------------------------------------------------------------------- | ------ | ------------------------------------------------ |
| `size`          | <code>int</code>                                                           | `0`    | Initial size of the array. Default is 0.         |
| `initial_value` | <code><a class="stdlib-ref" href="/zh-CN/api/prelude/Line">Line</a></code> | `na`   | Initial value for all elements. Default is `na`. |

**返回:** <code><a class="stdlib-ref" href="/zh-CN/api/prelude/Array">Array</a>&lt;<a class="stdlib-ref" href="/zh-CN/api/prelude/Line">Line</a>&gt;</code>
...
| --------------- | ---------------------------------------------------------------------------------- | ------ | ------------------------------------------------ |
| `size`          | <code>int</code>                                                                   | `0`    | Initial size of the array. Default is 0.         |
| `initial_value` | <code><a class="stdlib-ref" href="/zh-CN/api/prelude/LineFill">LineFill</a></code> | `na`   | Initial value for all elements. Default is `na`. |

**返回:** <code><a class="stdlib-ref" href="/zh-CN/api/prelude/Array">Array</a>&lt;<a class="stdlib-ref" href="/zh-CN/api/prelude/LineFill">LineFill</a>&gt;</code>
...
| --------------- | ------------------------------------------------------------------------------ | ------ | ------------------------------------------------ |
| `size`          | <code>int</code>                                                               | `0`    | Initial size of the array. Default is 0.         |
| `initial_value` | <code><a class="stdlib-ref" href="/zh-CN/api/prelude/String">String</a></code> | `na`   | Initial value for all elements. Default is `na`. |

**返回:** <code><a class="stdlib-ref" href="/zh-CN/api/prelude/Array">Array</a>&lt;<a class="stdlib-ref" href="/zh-CN/api/prelude/String">String</a>&gt;</code>
...
| --------------- | ---------------------------------------------------------------------------- | ------ | ------------------------------------------------ |
| `size`          | <code>int</code>                                                             | `0`    | Initial size of the array. Default is 0.         |
| `initial_value` | <code><a class="stdlib-ref" href="/zh-CN/api/prelude/Table">Table</a></code> | `na`   | Initial value for all elements. Default is `na`. |

**返回:** <code><a class="stdlib-ref" href="/zh-CN/api/prelude/Array">Array</a>&lt;<a class="stdlib-ref" href="/zh-CN/api/prelude/Table">Table</a>&gt;</code>
...
| 名称 | 类型                                                                                    | 默认值 | 说明                 |
| ---- | --------------------------------------------------------------------------------------- | ------ | -------------------- |
| `id` | <code><a class="stdlib-ref" href="/zh-CN/api/prelude/Array">Array</a>&lt;int&gt;</code> |        | 整数元素的传入数组。 |
...
| 名称 | 类型                                                                                      | 默认值 | 说明                 |
| ---- | ----------------------------------------------------------------------------------------- | ------ | -------------------- |
| `id` | <code><a class="stdlib-ref" href="/zh-CN/api/prelude/Array">Array</a>&lt;float&gt;</code> |        | 浮点元素的传入数组。 |
...
| 名称 | 类型                                                                                                | 默认值 | 说明                 |
| ---- | --------------------------------------------------------------------------------------------------- | ------ | -------------------- |
| `id` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-CN/api/prelude/Array">Array</a>&lt;int&gt;</code> |        | 整数元素的传入数组。 |
...
| 名称 | 类型                                                                                                  | 默认值 | 说明                 |
| ---- | ----------------------------------------------------------------------------------------------------- | ------ | -------------------- |
| `id` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-CN/api/prelude/Array">Array</a>&lt;float&gt;</code> |        | 浮点元素的传入数组。 |
...
| 名称    | 类型                                                                                    | 默认值 | 说明                     |
| ------- | --------------------------------------------------------------------------------------- | ------ | ------------------------ |
| `id`    | <code><a class="stdlib-ref" href="/zh-CN/api/prelude/Array">Array</a>&lt;int&gt;</code> |        | 要搜索的已排序整数数组。 |
...
| 名称    | 类型                                                                                      | 默认值 | 说明                     |
| ------- | ----------------------------------------------------------------------------------------- | ------ | ------------------------ |
| `id`    | <code><a class="stdlib-ref" href="/zh-CN/api/prelude/Array">Array</a>&lt;float&gt;</code> |        | 要搜索的已排序浮点数组。 |
...
| 名称 | 类型                                                                                              | 默认值 | 说明           |
| ---- | ------------------------------------------------------------------------------------------------- | ------ | -------------- |
| `id` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-CN/api/prelude/Array">Array</a>&lt;T&gt;</code> |        | 要清空的数组。 |
...
| 名称  | 类型                                                                                  | 默认值 | 说明                 |
| ----- | ------------------------------------------------------------------------------------- | ------ | -------------------- |
| `id1` | <code><a class="stdlib-ref" href="/zh-CN/api/prelude/Array">Array</a>&lt;T&gt;</code> |        | 要连接的第一个数组。 |
| `id2` | <code><a class="stdlib-ref" href="/zh-CN/api/prelude/Array">Array</a>&lt;T&gt;</code> |        | 要连接的第二个数组。 |
...
| 名称 | 类型                                                                                  | 默认值 | 说明           |
| ---- | ------------------------------------------------------------------------------------- | ------ | -------------- |
| `id` | <code><a class="stdlib-ref" href="/zh-CN/api/prelude/Array">Array</a>&lt;T&gt;</code> |        | 要复制的数组。 |
...
| 名称     | 类型                                                                                      | 默认值 | 说明                                                                                          |
| -------- | ----------------------------------------------------------------------------------------- | ------ | --------------------------------------------------------------------------------------------- |
| `id1`    | <code><a class="stdlib-ref" href="/zh-CN/api/prelude/Array">Array</a>&lt;float&gt;</code> |        | 第一个传入数组。                                                                              |
| `id2`    | <code><a class="stdlib-ref" href="/zh-CN/api/prelude/Array">Array</a>&lt;float&gt;</code> |        | 第二个传入数组。                                                                              |
...
| 名称     | 类型                                                                                    | 默认值 | 说明                                                                                          |
| -------- | --------------------------------------------------------------------------------------- | ------ | --------------------------------------------------------------------------------------------- |
| `id1`    | <code><a class="stdlib-ref" href="/zh-CN/api/prelude/Array">Array</a>&lt;int&gt;</code> |        | 第一个传入数组。                                                                              |
| `id2`    | <code><a class="stdlib-ref" href="/zh-CN/api/prelude/Array">Array</a>&lt;int&gt;</code> |        | 第二个传入数组。                                                                              |
| `biased` | <code>any</code>                                                                        | `true` | 如果是 `true`，则函数使用有偏估计（除以 `n`）；如果是 `false`，则使用无偏估计（除以 `n-1`）。 |
...
| 名称 | 类型                                                                                     | 默认值 | 说明           |
| ---- | ---------------------------------------------------------------------------------------- | ------ | -------------- |
| `id` | <code><a class="stdlib-ref" href="/zh-CN/api/prelude/Array">Array</a>&lt;bool&gt;</code> |        | 要检查的数组。 |
...
| 名称 | 类型                                                                                    | 默认值 | 说明           |
| ---- | --------------------------------------------------------------------------------------- | ------ | -------------- |
| `id` | <code><a class="stdlib-ref" href="/zh-CN/api/prelude/Array">Array</a>&lt;int&gt;</code> |        | 要检查的数组。 |
...
| 名称 | 类型                                                                                      | 默认值 | 说明           |
| ---- | ----------------------------------------------------------------------------------------- | ------ | -------------- |
| `id` | <code><a class="stdlib-ref" href="/zh-CN/api/prelude/Array">Array</a>&lt;float&gt;</code> |        | 要检查的数组。 |
...
| 名称         | 类型                                                                                  | 默认值 | 说明                                         |
| ------------ | ------------------------------------------------------------------------------------- | ------ | -------------------------------------------- |
| `id`         | <code><a class="stdlib-ref" href="/zh-CN/api/prelude/Array">Array</a>&lt;T&gt;</code> |        | 要填充的数组。                               |
...
| 名称 | 类型                                                                                  | 默认值 | 说明                         |
| ---- | ------------------------------------------------------------------------------------- | ------ | ---------------------------- |
| `id` | <code><a class="stdlib-ref" href="/zh-CN/api/prelude/Array">Array</a>&lt;T&gt;</code> |        | 要从中检索第一个元素的数组。 |
...
| 名称    | 类型                                                                                  | 默认值 | 说明                   |
| ------- | ------------------------------------------------------------------------------------- | ------ | ---------------------- |
| `id`    | <code><a class="stdlib-ref" href="/zh-CN/api/prelude/Array">Array</a>&lt;T&gt;</code> |        | 要从中检索元素的数组。 |
...
| 名称    | 类型                                                                                  | 默认值 | 说明           |
| ------- | ------------------------------------------------------------------------------------- | ------ | -------------- |
| `id`    | <code><a class="stdlib-ref" href="/zh-CN/api/prelude/Array">Array</a>&lt;T&gt;</code> |        | 要搜索的数组。 |
...
| 名称    | 类型                                                                                  | 默认值 | 说明             |
| ------- | ------------------------------------------------------------------------------------- | ------ | ---------------- |
| `id`    | <code><a class="stdlib-ref" href="/zh-CN/api/prelude/Array">Array</a>&lt;T&gt;</code> |        | 要修改的数组。   |
...
| 名称        | 类型                                                                                    | 默认值 | 说明                           |
| ----------- | --------------------------------------------------------------------------------------- | ------ | ------------------------------ |
| `id`        | <code><a class="stdlib-ref" href="/zh-CN/api/prelude/Array">Array</a>&lt;int&gt;</code> |        | 要连接的整数数组。             |
| `separator` | <code><a class="stdlib-ref" href="/zh-CN/api/prelude/String">String</a></code>          |        | 放置在元素之间的分隔符字符串。 |
...
| 名称        | 类型                                                                                      | 默认值 | 说明                           |
| ----------- | ----------------------------------------------------------------------------------------- | ------ | ------------------------------ |
| `id`        | <code><a class="stdlib-ref" href="/zh-CN/api/prelude/Array">Array</a>&lt;float&gt;</code> |        | 要加入的浮点数组。             |
| `separator` | <code><a class="stdlib-ref" href="/zh-CN/api/prelude/String">String</a></code>            |        | 放置在元素之间的分隔符字符串。 |
...
| 名称        | 类型                                                                                                                                                  | 默认值 | 说明                           |
| ----------- | ----------------------------------------------------------------------------------------------------------------------------------------------------- | ------ | ------------------------------ |
| `id`        | <code><a class="stdlib-ref" href="/zh-CN/api/prelude/Array">Array</a>&lt;<a class="stdlib-ref" href="/zh-CN/api/prelude/String">String</a>&gt;</code> |        | 要连接的字符串数组。           |
| `separator` | <code><a class="stdlib-ref" href="/zh-CN/api/prelude/String">String</a></code>                                                                        |        | 放置在元素之间的分隔符字符串。 |
...
| 名称 | 类型                                                                                  | 默认值 | 说明                           |
| ---- | ------------------------------------------------------------------------------------- | ------ | ------------------------------ |
| `id` | <code><a class="stdlib-ref" href="/zh-CN/api/prelude/Array">Array</a>&lt;T&gt;</code> |        | 要从中检索最后一个元素的数组。 |
...
| 名称  | 类型                                                                                    | 默认值 | 说明                                               |
| ----- | --------------------------------------------------------------------------------------- | ------ | -------------------------------------------------- |
| `id`  | <code><a class="stdlib-ref" href="/zh-CN/api/prelude/Array">Array</a>&lt;int&gt;</code> |        | 输入整数数组。                                     |
...
| 名称  | 类型                                                                                      | 默认值 | 说明                                               |
| ----- | ----------------------------------------------------------------------------------------- | ------ | -------------------------------------------------- |
| `id`  | <code><a class="stdlib-ref" href="/zh-CN/api/prelude/Array">Array</a>&lt;float&gt;</code> |        | 输入浮点数数组。                                   |
| `nth` | <code>int</code>                                                                          | `0`    | 返回哪个最大值（0 表示最大，1 表示第二大，等等）。 |
...
| 名称 | 类型                                                                                  | 默认值 | 说明                 |
| ---- | ------------------------------------------------------------------------------------- | ------ | -------------------- |
| `id` | <code><a class="stdlib-ref" href="/zh-CN/api/prelude/Array">Array</a>&lt;T&gt;</code> |        | 从中弹出元素的数组。 |
...
| 名称    | 类型                                                                                  | 默认值 | 说明               |
| ------- | ------------------------------------------------------------------------------------- | ------ | ------------------ |
| `id`    | <code><a class="stdlib-ref" href="/zh-CN/api/prelude/Array">Array</a>&lt;T&gt;</code> |        | 将附加值的数组。   |
...
| 名称 | 类型                                                                                  | 默认值 | 说明           |
| ---- | ------------------------------------------------------------------------------------- | ------ | -------------- |
| `id` | <code><a class="stdlib-ref" href="/zh-CN/api/prelude/Array">Array</a>&lt;T&gt;</code> |        | 要反转的数组。 |
...
| 名称 | 类型                                                                                  | 默认值 | 说明                   |
| ---- | ------------------------------------------------------------------------------------- | ------ | ---------------------- |
| `id` | <code><a class="stdlib-ref" href="/zh-CN/api/prelude/Array">Array</a>&lt;T&gt;</code> |        | 要从中移动元素的数组。 |
...
| 名称 | 类型                                                                                  | 默认值 | 说明               |
| ---- | ------------------------------------------------------------------------------------- | ------ | ------------------ |
| `id` | <code><a class="stdlib-ref" href="/zh-CN/api/prelude/Array">Array</a>&lt;T&gt;</code> |        | 待确定大小的数组。 |
...
| 名称         | 类型                                                                                  | 默认值 | 说明                                         |
| ------------ | ------------------------------------------------------------------------------------- | ------ | -------------------------------------------- |
| `id`         | <code><a class="stdlib-ref" href="/zh-CN/api/prelude/Array">Array</a>&lt;T&gt;</code> |        | 要切片的数组。                               |
| `index_from` | <code>int</code>                                                                      | `0`    | 起始索引（含）。                             |
| `index_to`   | <code>int</code>                                                                      | `na`   | 结束索引（不包括）。当 na 时，表示数组末尾。 |
...
| 名称    | 类型                                                                                    | 默认值                | 说明               |
| ------- | --------------------------------------------------------------------------------------- | --------------------- | ------------------ |
| `id`    | <code><a class="stdlib-ref" href="/zh-CN/api/prelude/Array">Array</a>&lt;int&gt;</code> |                       | 要排序的整数数组。 |
...
| 名称    | 类型                                                                                      | 默认值                | 说明               |
| ------- | ----------------------------------------------------------------------------------------- | --------------------- | ------------------ |
| `id`    | <code><a class="stdlib-ref" href="/zh-CN/api/prelude/Array">Array</a>&lt;float&gt;</code> |                       | 要排序的浮点数组。 |
| `order` | <code>any</code>                                                                          | `SortOrder.Ascending` | 排序顺序。         |
...
| 名称    | 类型                                                                                                                                                  | 默认值                | 说明                 |
| ------- | ----------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------- | -------------------- |
| `id`    | <code><a class="stdlib-ref" href="/zh-CN/api/prelude/Array">Array</a>&lt;<a class="stdlib-ref" href="/zh-CN/api/prelude/String">String</a>&gt;</code> |                       | 要排序的字符串数组。 |
| `order` | <code>any</code>                                                                                                                                      | `SortOrder.Ascending` | 排序顺序。           |
...
| 名称    | 类型                                                                                    | 默认值                | 说明               |
| ------- | --------------------------------------------------------------------------------------- | --------------------- | ------------------ |
| `id`    | <code><a class="stdlib-ref" href="/zh-CN/api/prelude/Array">Array</a>&lt;int&gt;</code> |                       | 要分析的整数数组。 |
| `order` | <code>any</code>                                                                        | `SortOrder.Ascending` | 排序顺序。         |

**返回:** <code><a class="stdlib-ref" href="/zh-CN/api/prelude/Array">Array</a>&lt;int&gt;</code> — 重新排列原始索引的数组，以便 `array.get(result.get(i))` 产生第 i 个排序元素。
...
| 名称    | 类型                                                                                      | 默认值                | 说明                 |
| ------- | ----------------------------------------------------------------------------------------- | --------------------- | -------------------- |
| `id`    | <code><a class="stdlib-ref" href="/zh-CN/api/prelude/Array">Array</a>&lt;float&gt;</code> |                       | 要分析的浮点数数组。 |
| `order` | <code>any</code>                                                                          | `SortOrder.Ascending` | 排序顺序。           |
...
| 名称    | 类型                                                                                                                                                  | 默认值                | 说明                 |
| ------- | ----------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------- | -------------------- |
| `id`    | <code><a class="stdlib-ref" href="/zh-CN/api/prelude/Array">Array</a>&lt;<a class="stdlib-ref" href="/zh-CN/api/prelude/String">String</a>&gt;</code> |                       | 要分析的字符串数组。 |
| `order` | <code>any</code>                                                                                                                                      | `SortOrder.Ascending` | 排序顺序。           |
...
**返回:** <code><a class="stdlib-ref" href="/zh-CN/api/prelude/Array">Array</a>&lt;float&gt;</code> — 一个新数组，其中每个元素都是 `(value - mean) / stdev` （z 分数）。
...
**返回:** <code><a class="stdlib-ref" href="/zh-CN/api/prelude/Array">Array</a>&lt;float&gt;</code> — 返回一个新数组，其中每个元素都是 `(value - mean) / stdev`（z 分数）。
