...
| 名称 | 类型 | 默认值 | 说明 |
| --- | --- | --- | --- |
| `first_point` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-CN/api/chart/Point">chart.Point</a></code> |  | 指定线的第一个点的 <code>chart.point</code> 对象。 |
| `second_point` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-CN/api/chart/Point">chart.Point</a></code> |  | 指定线的第二个点的 <code>chart.point</code> 对象。 |
...
| `color` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-CN/api/prelude/Color">Color</a></code> | `na` | 线条的颜色。 |
| `style` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-CN/api/prelude/LineStyle">LineStyle</a></code> | `LineStyle.Solid` | 线条样式。 |
| `width` | <code>series&nbsp;int</code> | `1` | 线宽（以像素为单位）。 |
| `force_overlay` | <code>series&nbsp;bool</code> | `false` | 如果为 true，则该线将呈现在顶部。 |

**返回:** <code>series&nbsp;<a class="stdlib-ref" href="/zh-CN/api/prelude/Line">Line</a></code>
...
**类型:** <code>series&nbsp;<a class="stdlib-ref" href="/zh-CN/api/prelude/Array">Array</a>&lt;<a class="stdlib-ref" href="/zh-CN/api/prelude/Line">Line</a>&gt;</code>
...
| 名称 | 类型 | 默认值 | 说明 |
| --- | --- | --- | --- |
| `id` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-CN/api/prelude/Line">Line</a></code> |  | 要复制的行。 |
...
| 名称 | 类型 | 默认值 | 说明 |
| --- | --- | --- | --- |
| `id` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-CN/api/prelude/Line">Line</a></code> |  | 要删除的行。 |
...
| 名称 | 类型 | 默认值 | 说明 |
| --- | --- | --- | --- |
| `id` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-CN/api/prelude/Line">Line</a></code> |  | 获取价格的线路。 |
...
| 名称 | 类型 | 默认值 | 说明 |
| --- | --- | --- | --- |
| `id` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-CN/api/prelude/Line">Line</a></code> |  | 从中获取 x1 坐标的线。 |
...
| 名称 | 类型 | 默认值 | 说明 |
| --- | --- | --- | --- |
| `id` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-CN/api/prelude/Line">Line</a></code> |  | 从中获取 x2 坐标的线。 |
...
| 名称 | 类型 | 默认值 | 说明 |
| --- | --- | --- | --- |
| `id` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-CN/api/prelude/Line">Line</a></code> |  | 从中获取 y1 坐标的线。 |
...
| 名称 | 类型 | 默认值 | 说明 |
| --- | --- | --- | --- |
| `id` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-CN/api/prelude/Line">Line</a></code> |  | 从中获取 y2 坐标的线。 |
...
| 名称 | 类型 | 默认值 | 说明 |
| --- | --- | --- | --- |
| `id` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-CN/api/prelude/Line">Line</a></code> |  | 要修改的行。 |
| `color` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-CN/api/prelude/Color">Color</a></code> |  | 线条的新颜色。 |
...
| --- | --- | --- | --- |
| `id` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-CN/api/prelude/Line">Line</a></code> |  | 要修改的行。 |
| `point` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-CN/api/chart/Point">chart.Point</a></code> |  | 指定新的第一个点的 <code>chart.point</code> 对象。 |
...
| --- | --- | --- | --- |
| `id` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-CN/api/prelude/Line">Line</a></code> |  | 要修改的行。 |
| `point` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-CN/api/chart/Point">chart.Point</a></code> |  | 指定新的第二个点的 <code>chart.point</code> 对象。 |
...
| --- | --- | --- | --- |
| `id` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-CN/api/prelude/Line">Line</a></code> |  | 要修改的行。 |
| `style` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-CN/api/prelude/LineStyle">LineStyle</a></code> |  | 新的线条样式。 |
