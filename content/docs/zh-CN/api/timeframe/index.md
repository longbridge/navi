...
**类型:** <code>simple&nbsp;<a class="stdlib-ref" href="/zh-CN/api/prelude/String">String</a></code>
...
| 名称 | 类型 | 默认值 | 说明 |
| --- | --- | --- | --- |
| `timeframe` | <code><a class="stdlib-ref" href="/zh-CN/api/prelude/String">String</a></code> |  |  |
...
**返回:** <code><a class="stdlib-ref" href="/zh-CN/api/prelude/String">String</a></code> — 时间范围字符串（例如，3600 返回“60”，86400 返回“D”）。
...
| 名称 | 类型 | 默认值 | 说明 |
| --- | --- | --- | --- |
| `timeframe` | <code><a class="stdlib-ref" href="/zh-CN/api/prelude/String">String</a></code> | `timeframe.period` | 要转换的时间范围字符串。默认为图表的时间范围。 |
