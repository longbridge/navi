...
**类型:** <code>simple&nbsp;<a class="stdlib-ref" href="/zh-CN/api/prelude/Session">Session</a></code>
...
| 名称 | 类型 | 默认值 | 说明 |
| --- | --- | --- | --- |
| `symbol` | <code><a class="stdlib-ref" href="/zh-CN/api/prelude/String">String</a></code> |  | 从中获取前缀的交易品种代码字符串。 |
...
| 名称 | 类型 | 默认值 | 说明 |
| --- | --- | --- | --- |
| `symbol` | <code><a class="stdlib-ref" href="/zh-CN/api/prelude/String">String</a></code> |  | 从中获取名称的交易品种股票字符串。 |
