...
| 名称                                   | 说明                                                                                                                                                           |
| -------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [`PivotType`](/zh-CN/api/ta/PivotType) | Pivot point calculation method for <a class="stdlib-ref" data-key="ta::pivot_point_levels" href="/zh-CN/api/ta/#pivot_point_levels">ta.pivot_point_levels</a>. |
...
| 名称     | 类型                                                                                        | 默认值 | 说明                                           |
| -------- | ------------------------------------------------------------------------------------------- | ------ | ---------------------------------------------- |
| `type`   | <code>series&nbsp;<a class="stdlib-ref" href="/zh-CN/api/ta/PivotType">PivotType</a></code> |        | The pivot calculation method.                  |
| `change` | <code>series&nbsp;bool</code>                                                               |        | `true` on the first bar of a new pivot period. |

**返回:** <code>series&nbsp;<a class="stdlib-ref" href="/zh-CN/api/prelude/Array">Array</a>&lt;float&gt;</code>
