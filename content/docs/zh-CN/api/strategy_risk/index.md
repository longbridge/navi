...
| 名称  | 类型                                                                                             | 默认值 | 说明 |
| ----- | ------------------------------------------------------------------------------------------------ | ------ | ---- |
| `dir` | <code>simple&nbsp;<a class="stdlib-ref" href="/zh-CN/api/prelude/Direction">Direction</a></code> |        |      |
...
| `type`  | <code>simple&nbsp;<a class="stdlib-ref" href="/zh-CN/api/prelude/DefaultQtyType">DefaultQtyType</a></code> |        | 值类型：`strategy.cash` 或 `strategy.percent_of_equity`。 |
