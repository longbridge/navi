...
**类型:** <code>series&nbsp;<a class="stdlib-ref" href="/zh-CN/api/prelude/String">String</a></code>

返回用于策略账户的货币代码，如 <a class="stdlib-ref" data-key="prelude::strategy" href="/zh-CN/api/prelude/#strategy">strategy</a> 声明中所设置。
...
返回用于市价订单的默认合约/股票/手数/单位数量。根据 <a class="stdlib-ref" data-key="prelude::strategy" href="/zh-CN/api/prelude/#strategy">strategy</a> 声明的 `default_qty_type` 和 `default_qty_value` 参数计算。价值取决于当前价格和净值。
...
返回 <a class="stdlib-ref" data-key="prelude::strategy" href="/zh-CN/api/prelude/#strategy">strategy</a> 声明中设置的初始大写字母。这是回测的起始现金，由 `initial_capital` 参数指定。
...
| 名称 | 类型 | 默认值 | 说明 |
| --- | --- | --- | --- |
| `id` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-CN/api/prelude/String">String</a></code> |  | 要取消的订单标识符。 |
...
| 名称 | 类型 | 默认值 | 说明 |
| --- | --- | --- | --- |
| `id` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-CN/api/prelude/String">String</a></code> |  | 要关闭的条目 ID。 |
| `comment` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-CN/api/prelude/String">String</a></code> | `na` | 生成的平仓订单的可选注释。 |
| `qty` | <code>series&nbsp;float</code> | `na` | 绝对数量关闭。 |
| `qty_percent` | <code>series&nbsp;float</code> | `na` | 平仓的百分比。 |
| `alert_message` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-CN/api/prelude/String">String</a></code> | `na` | 可选的警报消息。 |
...
| 名称 | 类型 | 默认值 | 说明 |
| --- | --- | --- | --- |
| `id` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-CN/api/prelude/String">String</a></code> |  | 唯一的订单标识符。 |
| `direction` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-CN/api/prelude/Direction">Direction</a></code> |  | 订单方：<code>strategy.long</code> 或 <code>strategy.short</code>。 |
...
| `oca_name` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-CN/api/prelude/String">String</a></code> | `na` | 可选的“一取消全”组名称。 |
| `oca_type` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-CN/api/prelude/OcaType">OcaType</a></code> | `OcaType.None` | OCA 行为，例如 `oca.cancel`、`oca.reduce` 或 `oca.none`。 |
| `comment` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-CN/api/prelude/String">String</a></code> | `na` | 可选订单评论。 |
| `alert_message` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-CN/api/prelude/String">String</a></code> | `na` | 此订单的可选警报消息。 |
...
| 名称 | 类型 | 默认值 | 说明 |
| --- | --- | --- | --- |
| `id` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-CN/api/prelude/String">String</a></code> |  | 唯一的退出指令标识符。 |
| `from_entry` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-CN/api/prelude/String">String</a></code> | `na` | 退出的入口 ID。当 `na` 时，退出适用于整个匹配位置。 |
...
| `oca_name` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-CN/api/prelude/String">String</a></code> | `na` | 可选的 OCA 组名称。 |
| `comment` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-CN/api/prelude/String">String</a></code> | `na` | 从此出口填充的默认注释。 |
| `comment_profit` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-CN/api/prelude/String">String</a></code> | `na` | 用于止盈填充的注释。 |
| `comment_loss` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-CN/api/prelude/String">String</a></code> | `na` | 用于止损填充的注释。 |
| `comment_trailing` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-CN/api/prelude/String">String</a></code> | `na` | 用于追踪止损填充的注释。 |
| `alert_message` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-CN/api/prelude/String">String</a></code> | `na` | 默认警报消息。 |
| `alert_profit` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-CN/api/prelude/String">String</a></code> | `na` | 用于止盈填充的警报消息。 |
| `alert_loss` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-CN/api/prelude/String">String</a></code> | `na` | 用于止损填充的警报消息。 |
| `alert_trailing` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-CN/api/prelude/String">String</a></code> | `na` | 用于追踪止损填充的警报消息。 |
