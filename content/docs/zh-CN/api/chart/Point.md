...
返回指定 bar 索引和价格处的 <a class="stdlib-ref" data-key="chart::Point" href="/zh-CN/api/chart/Point">chart.Point</a> 对象。
...
**返回:** <code><a class="stdlib-ref" href="/zh-CN/api/chart/Point">Point</a></code>
