...
Unlike <a class="stdlib-ref" data-key="math::atan" href="/api/math/#atan">atan</a>, this function takes two arguments and determines the correct quadrant using the signs of both. Useful for computing angles between vectors or points.
...
The inverse of <a class="stdlib-ref" data-key="math::log" href="/api/math/#log">log</a>. Useful for exponential growth/decay calculations.
...
The inverse of <a class="stdlib-ref" data-key="math::exp" href="/api/math/#exp">exp</a>. Returns `na` for non-positive values.
...
Unlike <a class="stdlib-ref" data-key="math::floor" href="/api/math/#floor">floor</a>, truncation toward zero is symmetric: `trunc(-1.9) = -1`, whereas `floor(-1.9) = -2`.
