...
| ----- | ------------------------------------------------------------------------------------------ | ------- | ----------- |
| `dir` | <code>simple&nbsp;<a class="stdlib-ref" href="/api/prelude/Direction">Direction</a></code> |         |             |
...
| `type`  | <code>simple&nbsp;<a class="stdlib-ref" href="/api/prelude/DefaultQtyType">DefaultQtyType</a></code> |         | The value type: `strategy.cash` or `strategy.percent_of_equity`. |
