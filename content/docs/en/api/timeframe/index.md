...
**Type:** <code>simple&nbsp;<a class="stdlib-ref" href="/api/prelude/String">String</a></code>
...
| --- | --- | --- | --- |
| `timeframe` | <code><a class="stdlib-ref" href="/api/prelude/String">String</a></code> |  |  |
...
**Returns:** <code><a class="stdlib-ref" href="/api/prelude/String">String</a></code> — A timeframe String (e.g., 3600 returns "60", 86400 returns "D").
...
| Name | Type | Default | Description |
| --- | --- | --- | --- |
| `timeframe` | <code><a class="stdlib-ref" href="/api/prelude/String">String</a></code> | `timeframe.period` | The timeframe String to convert. Defaults to the chart's timeframe. |
