...
**Type:** <code>simple&nbsp;<a class="stdlib-ref" href="/api/prelude/Session">Session</a></code>
...
| --- | --- | --- | --- |
| `symbol` | <code><a class="stdlib-ref" href="/api/prelude/String">String</a></code> |  | The symbol ticker String to get the prefix from. |
...
| Name | Type | Default | Description |
| --- | --- | --- | --- |
| `symbol` | <code><a class="stdlib-ref" href="/api/prelude/String">String</a></code> |  | The symbol ticker String to get the name from. |
