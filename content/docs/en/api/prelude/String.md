...
| `format`   | <code><a class="stdlib-ref" href="/api/prelude/String">String</a></code> |                        | The format String for the conversion.                |
| `timezone` | <code><a class="stdlib-ref" href="/api/prelude/String">String</a></code> | `symbol_info.timezone` | The timezone to use for formatting.                  |
...
Converts an integer to String using a <a class="stdlib-ref" data-key="prelude::Format" href="/api/prelude/Format">Format</a> constant.
...
| -------- | ------------------------------------------------------------------------ | ------- | --------------------------------------------------------------------------------------------------------------------------- |
| `value`  | <code>int</code>                                                         |         | The integer value to convert.                                                                                               |
| `format` | <code><a class="stdlib-ref" href="/api/prelude/Format">Format</a></code> |         | The <a class="stdlib-ref" data-key="prelude::Format" href="/api/prelude/Format">Format</a> constant controlling formatting. |

**Returns:** <code><a class="stdlib-ref" href="/api/prelude/String">String</a></code>

Converts a float to String using a <a class="stdlib-ref" data-key="prelude::Format" href="/api/prelude/Format">Format</a> constant.
...
| Name   | Type                                                                     | Default | Description                  |
| ------ | ------------------------------------------------------------------------ | ------- | ---------------------------- |
| `self` | <code><a class="stdlib-ref" href="/api/prelude/String">String</a></code> |         |                              |
| `str`  | <code><a class="stdlib-ref" href="/api/prelude/String">String</a></code> |         | The substring to search for. |
...
| ------ | ------------------------------------------------------------------------ | ------- | ------------------------- |
| `self` | <code><a class="stdlib-ref" href="/api/prelude/String">String</a></code> |         |                           |
| `str`  | <code><a class="stdlib-ref" href="/api/prelude/String">String</a></code> |         | The suffix to search for. |
...
| ------- | ------------------------------------------------------------------------ | ------- | ---------------------------------------- |
| `self`  | <code><a class="stdlib-ref" href="/api/prelude/String">String</a></code> |         |                                          |
| `regex` | <code><a class="stdlib-ref" href="/api/prelude/String">String</a></code> |         | The regular expression pattern to match. |
...
| `fill` | <code><a class="stdlib-ref" href="/api/prelude/String">String</a></code> | `" "`   | The padding String. Defaults to `" "`.   |
...
| ------------- | ------------------------------------------------------------------------ | ------- | -------------------------------------------------------- |
| `self`        | <code><a class="stdlib-ref" href="/api/prelude/String">String</a></code> |         |                                                          |
| `target`      | <code><a class="stdlib-ref" href="/api/prelude/String">String</a></code> |         | The substring to be replaced.                            |
| `replacement` | <code><a class="stdlib-ref" href="/api/prelude/String">String</a></code> |         | The replacement substring.                               |
...
| ----------- | ------------------------------------------------------------------------ | ------- | --------------------------------- |
| `self`      | <code><a class="stdlib-ref" href="/api/prelude/String">String</a></code> |         |                                   |
| `separator` | <code><a class="stdlib-ref" href="/api/prelude/String">String</a></code> |         | The separator String to split on. |
...
| ------ | ------------------------------------------------------------------------ | ------- | ------------------------- |
| `self` | <code><a class="stdlib-ref" href="/api/prelude/String">String</a></code> |         |                           |
| `str`  | <code><a class="stdlib-ref" href="/api/prelude/String">String</a></code> |         | The prefix to search for. |
