...
| --------------- | ------------------------------------------------------------------------------------------ | ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------- |
| `first_point`   | <code>series&nbsp;<a class="stdlib-ref" href="/api/chart/Point">chart.Point</a></code>     |                   | The <a class="stdlib-ref" data-key="chart::Point" href="/api/chart/Point">chart.Point</a> object specifying the first point of the line.  |
| `second_point`  | <code>series&nbsp;<a class="stdlib-ref" href="/api/chart/Point">chart.Point</a></code>     |                   | The <a class="stdlib-ref" data-key="chart::Point" href="/api/chart/Point">chart.Point</a> object specifying the second point of the line. |
...
| `color`         | <code>series&nbsp;<a class="stdlib-ref" href="/api/prelude/Color">Color</a></code>         | `na`              | The color of the line.                                                                                                                    |
| `style`         | <code>series&nbsp;<a class="stdlib-ref" href="/api/prelude/LineStyle">LineStyle</a></code> | `LineStyle.Solid` | The line style.                                                                                                                           |
...
**Returns:** <code>series&nbsp;<a class="stdlib-ref" href="/api/prelude/Line">Line</a></code>
...
**Type:** <code>series&nbsp;<a class="stdlib-ref" href="/api/prelude/Array">Array</a>&lt;<a class="stdlib-ref" href="/api/prelude/Line">Line</a>&gt;</code>
...
| Name | Type                                                                             | Default | Description       |
| ---- | -------------------------------------------------------------------------------- | ------- | ----------------- |
| `id` | <code>series&nbsp;<a class="stdlib-ref" href="/api/prelude/Line">Line</a></code> |         | The line to copy. |
...
| Name | Type                                                                             | Default | Description         |
| ---- | -------------------------------------------------------------------------------- | ------- | ------------------- |
| `id` | <code>series&nbsp;<a class="stdlib-ref" href="/api/prelude/Line">Line</a></code> |         | The line to delete. |
...
| Name | Type                                                                             | Default | Description                                     |
| ---- | -------------------------------------------------------------------------------- | ------- | ----------------------------------------------- |
| `id` | <code>series&nbsp;<a class="stdlib-ref" href="/api/prelude/Line">Line</a></code> |         | The line to get the price from.                 |
...
| Name | Type                                                                             | Default | Description                             |
| ---- | -------------------------------------------------------------------------------- | ------- | --------------------------------------- |
| `id` | <code>series&nbsp;<a class="stdlib-ref" href="/api/prelude/Line">Line</a></code> |         | The line to get the x1 coordinate from. |
...
| Name | Type                                                                             | Default | Description                             |
| ---- | -------------------------------------------------------------------------------- | ------- | --------------------------------------- |
| `id` | <code>series&nbsp;<a class="stdlib-ref" href="/api/prelude/Line">Line</a></code> |         | The line to get the x2 coordinate from. |
...
| Name | Type                                                                             | Default | Description                             |
| ---- | -------------------------------------------------------------------------------- | ------- | --------------------------------------- |
| `id` | <code>series&nbsp;<a class="stdlib-ref" href="/api/prelude/Line">Line</a></code> |         | The line to get the y1 coordinate from. |
...
| Name | Type                                                                             | Default | Description                             |
| ---- | -------------------------------------------------------------------------------- | ------- | --------------------------------------- |
| `id` | <code>series&nbsp;<a class="stdlib-ref" href="/api/prelude/Line">Line</a></code> |         | The line to get the y2 coordinate from. |
...
| Name    | Type                                                                               | Default | Description                |
| ------- | ---------------------------------------------------------------------------------- | ------- | -------------------------- |
| `id`    | <code>series&nbsp;<a class="stdlib-ref" href="/api/prelude/Line">Line</a></code>   |         | The line to modify.        |
| `color` | <code>series&nbsp;<a class="stdlib-ref" href="/api/prelude/Color">Color</a></code> |         | The new color of the line. |
...
| ------- | -------------------------------------------------------------------------------------- | ------- | -------------------------------------------------------------------------------------------------------------------------------- |
| `id`    | <code>series&nbsp;<a class="stdlib-ref" href="/api/prelude/Line">Line</a></code>       |         | The line to modify.                                                                                                              |
| `point` | <code>series&nbsp;<a class="stdlib-ref" href="/api/chart/Point">chart.Point</a></code> |         | The <a class="stdlib-ref" data-key="chart::Point" href="/api/chart/Point">chart.Point</a> object specifying the new first point. |
...
| ------- | -------------------------------------------------------------------------------------- | ------- | --------------------------------------------------------------------------------------------------------------------------------- |
| `id`    | <code>series&nbsp;<a class="stdlib-ref" href="/api/prelude/Line">Line</a></code>       |         | The line to modify.                                                                                                               |
| `point` | <code>series&nbsp;<a class="stdlib-ref" href="/api/chart/Point">chart.Point</a></code> |         | The <a class="stdlib-ref" data-key="chart::Point" href="/api/chart/Point">chart.Point</a> object specifying the new second point. |
...
| ------- | ------------------------------------------------------------------------------------------ | ------- | ------------------- |
| `id`    | <code>series&nbsp;<a class="stdlib-ref" href="/api/prelude/Line">Line</a></code>           |         | The line to modify. |
| `style` | <code>series&nbsp;<a class="stdlib-ref" href="/api/prelude/LineStyle">LineStyle</a></code> |         | The new line style. |
