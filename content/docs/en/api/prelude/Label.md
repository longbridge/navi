...
| --- | --- | --- | --- |
| `point` | <code>series&nbsp;<a class="stdlib-ref" href="/api/chart/Point">chart.Point</a></code> |  | The <a class="stdlib-ref" data-key="chart::Point" href="/api/chart/Point">chart.Point</a> object specifying the position of the label. |
| `text` | <code>series&nbsp;<a class="stdlib-ref" href="/api/prelude/String">String</a></code> | `""` | The text to display on the label. |
...
| `yloc` | <code>series&nbsp;<a class="stdlib-ref" href="/api/prelude/YLoc">YLoc</a></code> | `YLoc.Price` | The y-location type: YLoc.Price or YLoc.Price_range. |
| `color` | <code>series&nbsp;<a class="stdlib-ref" href="/api/prelude/Color">Color</a></code> | `na` | The background color of the label. |
| `style` | <code>series&nbsp;<a class="stdlib-ref" href="/api/prelude/LabelStyle">LabelStyle</a></code> | `LabelStyle.Down` | The style of the label. |
| `text_color` | <code>series&nbsp;<a class="stdlib-ref" href="/api/prelude/Color">Color</a></code> | `na` | The color of the label text. |
| `size` | <code>series&nbsp;<a class="stdlib-ref" href="/api/prelude/Size">Size</a></code> | `Size.Normal` | The size of the label as a named constant. |
| `text_align` | <code>series&nbsp;<a class="stdlib-ref" href="/api/prelude/TextHAlign">TextHAlign</a></code> | `TextHAlign.Center` | The text alignment: TextHAlign.Center, TextHAlign.Left, or TextHAlign.Right. |
| `tooltip` | <code>series&nbsp;<a class="stdlib-ref" href="/api/prelude/String">String</a></code> | `na` | The tooltip text when hovering over the label. |
| `text_font_family` | <code>series&nbsp;<a class="stdlib-ref" href="/api/prelude/FontFamily">FontFamily</a></code> | `FontFamily.Default` | The font family for the label text. |
...
**Returns:** <code>series&nbsp;<a class="stdlib-ref" href="/api/prelude/Label">Label</a></code>
...
**Type:** <code>series&nbsp;<a class="stdlib-ref" href="/api/prelude/Array">Array</a>&lt;<a class="stdlib-ref" href="/api/prelude/Label">Label</a>&gt;</code>
...
| Name | Type | Default | Description |
| --- | --- | --- | --- |
| `id` | <code>series&nbsp;<a class="stdlib-ref" href="/api/prelude/Label">Label</a></code> |  | The label to copy. |
...
| Name | Type | Default | Description |
| --- | --- | --- | --- |
| `id` | <code>series&nbsp;<a class="stdlib-ref" href="/api/prelude/Label">Label</a></code> |  | The label to delete. |
...
| Name | Type | Default | Description |
| --- | --- | --- | --- |
| `id` | <code>series&nbsp;<a class="stdlib-ref" href="/api/prelude/Label">Label</a></code> |  | The label to get the text from. |

**Returns:** <code>series&nbsp;<a class="stdlib-ref" href="/api/prelude/String">String</a></code>
...
| Name | Type | Default | Description |
| --- | --- | --- | --- |
| `id` | <code>series&nbsp;<a class="stdlib-ref" href="/api/prelude/Label">Label</a></code> |  | The label to get the x-coordinate from. |
...
| Name | Type | Default | Description |
| --- | --- | --- | --- |
| `id` | <code>series&nbsp;<a class="stdlib-ref" href="/api/prelude/Label">Label</a></code> |  | The label to get the y-coordinate from. |
...
| Name | Type | Default | Description |
| --- | --- | --- | --- |
| `id` | <code>series&nbsp;<a class="stdlib-ref" href="/api/prelude/Label">Label</a></code> |  | The label to modify. |
...
| --- | --- | --- | --- |
| `id` | <code>series&nbsp;<a class="stdlib-ref" href="/api/prelude/Label">Label</a></code> |  | The label to modify. |
| `point` | <code>series&nbsp;<a class="stdlib-ref" href="/api/chart/Point">chart.Point</a></code> |  | The `chart.Point` object specifying the new position. |
...
| --- | --- | --- | --- |
| `id` | <code>series&nbsp;<a class="stdlib-ref" href="/api/prelude/Label">Label</a></code> |  | The label to modify. |
| `size` | <code>series&nbsp;<a class="stdlib-ref" href="/api/prelude/Size">Size</a></code> |  | The new size as a named constant (Size.Tiny, Size.Small, Size.Normal, Size.Large, Size.Huge). |
...
| --- | --- | --- | --- |
| `id` | <code>series&nbsp;<a class="stdlib-ref" href="/api/prelude/Label">Label</a></code> |  | The label to modify. |
| `style` | <code>series&nbsp;<a class="stdlib-ref" href="/api/prelude/LabelStyle">LabelStyle</a></code> |  | The new label style constant. |
...
| --- | --- | --- | --- |
| `id` | <code>series&nbsp;<a class="stdlib-ref" href="/api/prelude/Label">Label</a></code> |  | The label to modify. |
| `text` | <code>series&nbsp;<a class="stdlib-ref" href="/api/prelude/String">String</a></code> |  | The new text to display. |
...
| --- | --- | --- | --- |
| `id` | <code>series&nbsp;<a class="stdlib-ref" href="/api/prelude/Label">Label</a></code> |  | The label to modify. |
| `text_align` | <code>series&nbsp;<a class="stdlib-ref" href="/api/prelude/TextHAlign">TextHAlign</a></code> |  | The text alignment: TextHAlign.Center, TextHAlign.Left, or TextHAlign.Right. |
...
| --- | --- | --- | --- |
| `id` | <code>series&nbsp;<a class="stdlib-ref" href="/api/prelude/Label">Label</a></code> |  | The label to modify. |
| `text_font_family` | <code>series&nbsp;<a class="stdlib-ref" href="/api/prelude/FontFamily">FontFamily</a></code> |  | The font family: FontFamily.Default or FontFamily.Monospace. |
...
| --- | --- | --- | --- |
| `id` | <code>series&nbsp;<a class="stdlib-ref" href="/api/prelude/Label">Label</a></code> |  | The label to modify. |
| `tooltip` | <code>series&nbsp;<a class="stdlib-ref" href="/api/prelude/String">String</a></code> |  | The new tooltip text. |
...
| --- | --- | --- | --- |
| `id` | <code>series&nbsp;<a class="stdlib-ref" href="/api/prelude/Label">Label</a></code> |  | The label to modify. |
| `yloc` | <code>series&nbsp;<a class="stdlib-ref" href="/api/prelude/YLoc">YLoc</a></code> |  | The y-location type: YLoc.Price or YLoc.Price_range. |
