...
**Type:** <code>const&nbsp;<a class="stdlib-ref" href="/api/prelude/PlotDisplay">PlotDisplay</a></code>
...
`display` flag that makes a <a class="stdlib-ref" data-key="prelude::plot" href="/api/prelude/#plot">plot</a> value available to Screener integrations.
...
| --- | --- | --- | --- |
| `a` | <code><a class="stdlib-ref" href="/api/prelude/PlotDisplay">PlotDisplay</a></code> |  |  |
| `b` | <code><a class="stdlib-ref" href="/api/prelude/PlotDisplay">PlotDisplay</a></code> |  |  |

**Returns:** <code><a class="stdlib-ref" href="/api/prelude/PlotDisplay">PlotDisplay</a></code>
