...
| ------- | ---------------------------------------------------------------------------------- | ------- | ----------- |
| `line1` | <code>series&nbsp;<a class="stdlib-ref" href="/api/prelude/Line">Line</a></code>   |         |             |
| `line2` | <code>series&nbsp;<a class="stdlib-ref" href="/api/prelude/Line">Line</a></code>   |         |             |
| `color` | <code>series&nbsp;<a class="stdlib-ref" href="/api/prelude/Color">Color</a></code> |         |             |

**Returns:** <code>series&nbsp;<a class="stdlib-ref" href="/api/prelude/LineFill">LineFill</a></code>

## Static Properties

### all {#all}

**Type:** <code>series&nbsp;<a class="stdlib-ref" href="/api/prelude/Array">Array</a>&lt;<a class="stdlib-ref" href="/api/prelude/LineFill">LineFill</a>&gt;</code>
...
| Name | Type                                                                                     | Default | Description |
| ---- | ---------------------------------------------------------------------------------------- | ------- | ----------- |
| `id` | <code>series&nbsp;<a class="stdlib-ref" href="/api/prelude/LineFill">LineFill</a></code> |         |             |
