...
| 名称 | 类型 | 默认值 | 说明 |
| --- | --- | --- | --- |
| `length` | <code>simple&nbsp;int</code> |  | 回溯周期（必须 &gt;= 2）。 |
...
| 名称 | 类型 | 默认值 | 说明 |
| --- | --- | --- | --- |
| `length` | <code>simple&nbsp;int</code> |  | 用于累积的 bars 数量。 |
...
| `length` | <code>simple&nbsp;int</code> |  | 平滑周期。 |
...
| 名称 | 类型 | 默认值 | 说明 |
| --- | --- | --- | --- |
| `type` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-CN/api/stdlib/ta/PivotType">PivotType</a></code> |  | 枢轴点计算方法。 |
| `change` | <code>series&nbsp;bool</code> |  | 在新枢轴周期的第一根 bar 上为 `true`。 |
...
| 名称 | 类型 | 默认值 | 说明 |
| --- | --- | --- | --- |
| `source` | <code>series&nbsp;float</code> |  | 要分析的价格系列。 |
| `length` | <code>simple&nbsp;int</code> |  | 回溯周期。 |
