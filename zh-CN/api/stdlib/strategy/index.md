...
| 名称 | 类型 | 默认值 | 说明 |
| --- | --- | --- | --- |
| `id` | <code>series&nbsp;string</code> |  | 要取消的订单标识符。 |
...
| 名称 | 类型 | 默认值 | 说明 |
| --- | --- | --- | --- |
| `id` | <code>series&nbsp;string</code> |  | 要关闭的条目 ID。 |
| `comment` | <code>series&nbsp;string</code> | `na` | 生成的平仓订单的可选注释。 |
| `qty` | <code>series&nbsp;float</code> | `na` | 绝对数量关闭。 |
| `qty_percent` | <code>series&nbsp;float</code> | `na` | 平仓的百分比。 |
| `alert_message` | <code>series&nbsp;string</code> | `na` | 可选的警报消息。 |
...
| 名称 | 类型 | 默认值 | 说明 |
| --- | --- | --- | --- |
| `id` | <code>series&nbsp;string</code> |  | 唯一的订单标识符。 |
...
| `oca_name` | <code>series&nbsp;string</code> | `na` | 可选的“一取消全”组名称。 |
...
| `comment` | <code>series&nbsp;string</code> | `na` | 可选订单评论。 |
| `alert_message` | <code>series&nbsp;string</code> | `na` | 此订单的可选警报消息。 |
...
| 名称 | 类型 | 默认值 | 说明 |
| --- | --- | --- | --- |
| `id` | <code>series&nbsp;string</code> |  | 唯一的退出指令标识符。 |
| `from_entry` | <code>series&nbsp;string</code> | `na` | 退出的入口 ID。当 `na` 时，退出适用于整个匹配位置。 |
...
| `oca_name` | <code>series&nbsp;string</code> | `na` | 可选的 OCA 组名称。 |
| `comment` | <code>series&nbsp;string</code> | `na` | 从此出口填充的默认注释。 |
| `comment_profit` | <code>series&nbsp;string</code> | `na` | 用于止盈填充的注释。 |
| `comment_loss` | <code>series&nbsp;string</code> | `na` | 用于止损填充的注释。 |
| `comment_trailing` | <code>series&nbsp;string</code> | `na` | 用于追踪止损填充的注释。 |
| `alert_message` | <code>series&nbsp;string</code> | `na` | 默认警报消息。 |
| `alert_profit` | <code>series&nbsp;string</code> | `na` | 用于止盈填充的警报消息。 |
| `alert_loss` | <code>series&nbsp;string</code> | `na` | 用于止损填充的警报消息。 |
| `alert_trailing` | <code>series&nbsp;string</code> | `na` | 用于追踪止损填充的警报消息。 |
