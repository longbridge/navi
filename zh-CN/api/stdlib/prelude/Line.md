...
| `color` | <code>series&nbsp;color</code> | `na` | 线条的颜色。 |
...
**类型:** <code>series&nbsp;<a class="stdlib-ref" href="/zh-CN/api/stdlib/prelude/Array">Array&lt;<a class="stdlib-ref" href="/zh-CN/api/stdlib/prelude/Line">Line</a>&gt;</a></code>
...
| `color` | <code>series&nbsp;color</code> |  | 线条的新颜色。 |
