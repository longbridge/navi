...
| `text` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-CN/api/stdlib/prelude/String">String</a></code> | `na` | 框的文本内容。 |
...
| --- | --- | --- | --- |
| `id` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-CN/api/stdlib/prelude/Box">Box</a></code> |  | 要修改的框。 |
| `font_family` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-CN/api/stdlib/prelude/FontFamily">FontFamily</a></code> |  | 字体系列：FontFamily.Default 或 FontFamily.Monospace。 |
...
| --- | --- | --- | --- |
| `id` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-CN/api/stdlib/prelude/Box">Box</a></code> |  | 要修改的框。 |
| `font_family` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-CN/api/stdlib/prelude/String">String</a></code> |  | 字体系列：「default」或「monospace」。 |
