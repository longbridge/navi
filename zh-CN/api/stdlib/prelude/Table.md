...
| `bgcolor` | <code>series&nbsp;color</code> | `na` | 表格的背景颜色。 |
| `frame_color` | <code>series&nbsp;color</code> | `na` | 表格的边框颜色。 |
| `frame_width` | <code>series&nbsp;int</code> | `0` | 框架边框宽度（以像素为单位）。 |
| `border_color` | <code>series&nbsp;color</code> | `na` | 表格边框颜色。 |
...
**类型:** <code>series&nbsp;<a class="stdlib-ref" href="/zh-CN/api/stdlib/prelude/Array">Array&lt;<a class="stdlib-ref" href="/zh-CN/api/stdlib/prelude/Table">Table</a>&gt;</a></code>
...
| `bgcolor` | <code>series&nbsp;color</code> | `na` | 单元格的背景颜色。 |
| `tooltip` | <code>series&nbsp;string</code> | `na` | 单元格的工具提示文本。 |
...
| `text_formatting` | <code>const&nbsp;<a class="stdlib-ref" href="/zh-CN/api/stdlib/prelude/TextFormat">TextFormat</a></code> | `text.NONE` | 文本格式选项。 |
...
| `column` | <code>series&nbsp;int</code> |  | 单元格的列索引（从 0 开始）。 |
| `row` | <code>series&nbsp;int</code> |  | 单元格的行索引（从 0 开始）。 |
| `bgcolor` | <code>series&nbsp;color</code> |  | 单元格的新背景颜色。 |
...
| `column` | <code>series&nbsp;int</code> |  | 单元格的列索引（从 0 开始）。 |
| `row` | <code>series&nbsp;int</code> |  | 单元格的行索引（从 0 开始）。 |
| `text` | <code>series&nbsp;string</code> |  | 单元格的新文本内容。 |
...
| `column` | <code>series&nbsp;int</code> |  | 单元格的列索引（从 0 开始）。 |
| `row` | <code>series&nbsp;int</code> |  | 单元格的行索引（从 0 开始）。 |
| `text_color` | <code>series&nbsp;color</code> |  | 单元格的新文本颜色。 |
...
| `column` | <code>series&nbsp;int</code> |  | 单元格的列索引（从 0 开始）。 |
| `row` | <code>series&nbsp;int</code> |  | 单元格的行索引（从 0 开始）。 |
| `text_font_family` | <code>series&nbsp;string</code> |  | 字体系列：FontFamily.Default 或 FontFamily.Monospace。 |
...
| `column` | <code>series&nbsp;int</code> |  | 单元格的列索引（从 0 开始）。 |
| `row` | <code>series&nbsp;int</code> |  | 单元格的行索引（从 0 开始）。 |
| `text_halign` | <code>series&nbsp;string</code> |  | 水平文本对齐方式：TextHAlign.Left、TextHAlign.Center 或 TextHAlign.Right。 |
...
| `column` | <code>series&nbsp;int</code> |  | 单元格的列索引（从 0 开始）。 |
| `row` | <code>series&nbsp;int</code> |  | 单元格的行索引（从 0 开始）。 |
| `text_valign` | <code>series&nbsp;string</code> |  | 垂直文本对齐方式：text.align_top、TextHAlign.Center 或 text.align_bottom。 |
...
| `column` | <code>series&nbsp;int</code> |  | 单元格的列索引（从 0 开始）。 |
| `row` | <code>series&nbsp;int</code> |  | 单元格的行索引（从 0 开始）。 |
| `tooltip` | <code>series&nbsp;string</code> |  | 单元格的新工具提示文本。 |
...
| --- | --- | --- | --- |
| `table_id` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-CN/api/stdlib/prelude/Table">Table</a></code> |  | 要修改的表对象。 |
| `bgcolor` | <code>series&nbsp;color</code> |  | 表格的新背景颜色。 |
...
| --- | --- | --- | --- |
| `table_id` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-CN/api/stdlib/prelude/Table">Table</a></code> |  | 要修改的表对象。 |
| `border_color` | <code>series&nbsp;color</code> |  | 表格的新边框颜色。 |
...
| --- | --- | --- | --- |
| `table_id` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-CN/api/stdlib/prelude/Table">Table</a></code> |  | 要修改的表对象。 |
| `frame_color` | <code>series&nbsp;color</code> |  | 表格的新框架边框颜色。 |
