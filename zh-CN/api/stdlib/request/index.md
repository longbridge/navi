...
| 名称 | 类型 | 默认值 | 说明 |
| --- | --- | --- | --- |
| `from` | <code>series&nbsp;string</code> |  | 源货币代码，例如`\"USD\"` 或 `currency.USD`。 |
| `to` | <code>series&nbsp;string</code> |  | 目标货币代码，例如`\"EUR\"` 或 `currency.EUR`。 |
...
| 名称 | 类型 | 默认值 | 说明 |
| --- | --- | --- | --- |
| `function` | <code>simple&nbsp;string</code> |  | 要调用的 DataProvider 函数名称。 |
| `args` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-CN/api/stdlib/prelude/Map">Map&lt;string, any&gt;</a></code> | `na` | 传递给函数的可选 `map&lt;string, any&gt;` 类型参数。 |
...
| 名称 | 类型 | 默认值 | 说明 |
| --- | --- | --- | --- |
| `ticker` | <code>series&nbsp;string</code> | `syminfo.tickerid` | 查询股息的股票；默认为图表符号。 |
...
| `currency` | <code>series&nbsp;string</code> | `syminfo.currency` | 用于价值转换的货币代码。 |
...
| 名称 | 类型 | 默认值 | 说明 |
| --- | --- | --- | --- |
| `ticker` | <code>series&nbsp;string</code> | `syminfo.tickerid` | 查询收益的股票；默认为图表符号。 |
...
| 名称 | 类型 | 默认值 | 说明 |
| --- | --- | --- | --- |
| `country_code` | <code>series&nbsp;string</code> |  | ISO 3166-1 alpha-2 国家/地区代码，例如__代码0__，__代码1__。 |
| `field` | <code>series&nbsp;string</code> |  | 要检索的经济指标的标识符。 |
| `gaps` | <code>simple&nbsp;<a class="stdlib-ref" href="/zh-CN/api/stdlib/prelude/BarmergeGaps">BarmergeGaps</a></code> | `BarmergeGaps.Off` | 条形映射模式（请参阅 <a class="stdlib-ref" data-key="prelude::BarmergeGaps" href="/zh-CN/api/stdlib/prelude/BarmergeGaps">BarmergeGaps.Off</a> / <a class="stdlib-ref" data-key="prelude::BarmergeGaps" href="/zh-CN/api/stdlib/prelude/BarmergeGaps">BarmergeGaps.On</a>）。 |
...
| 名称 | 类型 | 默认值 | 说明 |
| --- | --- | --- | --- |
| `symbol` | <code>series&nbsp;string</code> |  | 要查询其财务状况的符号。 |
| `financial_id` | <code>series&nbsp;string</code> |  | 要检索的财务指标的标识符。 |
| `period` | <code>series&nbsp;string</code> |  | 报告期：`\"FQ`（季度）或`FY\"`（年度）。 |
...
| `currency` | <code>series&nbsp;string</code> | `syminfo.currency` | 用于价值转换的货币代码；默认为图表符号的货币。 |
...
| 名称 | 类型 | 默认值 | 说明 |
| --- | --- | --- | --- |
| `symbol` | <code>series&nbsp;string</code> |  | 请求的符号。 |
| `timeframe` | <code>series&nbsp;string</code> |  | 请求的时间范围字符串，例如 `\"D`、`60` 或 `W\"`。 |
...
| `currency` | <code>series&nbsp;string</code> | `na` | 用于价格转换的可选货币。 |
...
| --- | --- | --- | --- |
| `symbol` | <code>series&nbsp;string</code> |  | 请求的符号。 |
| `timeframe` | <code>series&nbsp;string</code> |  | 较低或等于时间范围字符串，例如 `\"1` 或 `5\"`。 |
...
**返回:** <code>series&nbsp;<a class="stdlib-ref" href="/zh-CN/api/stdlib/prelude/Array">Array&lt;T&gt;</a></code>
...
| 名称 | 类型 | 默认值 | 说明 |
| --- | --- | --- | --- |
| `ticker` | <code>series&nbsp;string</code> | `syminfo.tickerid` | 要查询其拆分的股票代码；默认为图表符号。 |
