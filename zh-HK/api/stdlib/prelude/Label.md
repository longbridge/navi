...
| `text` | <code>series&nbsp;string</code> | `""` | 要在標籤上顯示的文本。 |
...
| `color` | <code>series&nbsp;color</code> | `na` | 標籤的背景顏色。 |
| `style` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-HK/api/stdlib/prelude/LabelStyle">LabelStyle</a></code> | `LabelStyle.Down` | 標籤的樣式。 |
| `text_color` | <code>series&nbsp;color</code> | `na` | 標籤文本的顏色。 |
| `size` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-HK/api/stdlib/prelude/Size">Size</a></code> | `Size.Normal` | 標籤的大小作為命名常量。 |
| `textalign` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-HK/api/stdlib/prelude/TextHAlign">TextHAlign</a></code> | `TextHAlign.Center` | 文本對齊方式：TextHAlign.Center、TextHAlign.Left 或 TextHAlign.Right。 |
| `tooltip` | <code>series&nbsp;string</code> | `na` | 將鼠標懸停在標籤上時的工具提示文本。 |
...
**類型:** <code>series&nbsp;<a class="stdlib-ref" href="/zh-HK/api/stdlib/prelude/Array">Array&lt;<a class="stdlib-ref" href="/zh-HK/api/stdlib/prelude/Label">Label</a>&gt;</a></code>
...
| --- | --- | --- | --- |
| `id` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-HK/api/stdlib/prelude/Label">Label</a></code> |  | 要修改的標籤。 |
| `text` | <code>series&nbsp;string</code> |  | 要顯示的新文本。 |
...
| --- | --- | --- | --- |
| `id` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-HK/api/stdlib/prelude/Label">Label</a></code> |  | 要修改的標籤。 |
| `textalign` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-HK/api/stdlib/prelude/TextHAlign">TextHAlign</a></code> |  | 文本對齊方式：TextHAlign.Center、TextHAlign.Left 或 TextHAlign.Right。 |
...
| --- | --- | --- | --- |
| `id` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-HK/api/stdlib/prelude/Label">Label</a></code> |  | 要修改的標籤。 |
| `tooltip` | <code>series&nbsp;string</code> |  | 新的工具提示文本。 |
