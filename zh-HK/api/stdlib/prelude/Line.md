...
| `color` | <code>series&nbsp;color</code> | `na` | 線條的顏色。 |
...
**類型:** <code>series&nbsp;<a class="stdlib-ref" href="/zh-HK/api/stdlib/prelude/Array">Array&lt;<a class="stdlib-ref" href="/zh-HK/api/stdlib/prelude/Line">Line</a>&gt;</a></code>
...
| `color` | <code>series&nbsp;color</code> |  | 線條的新顏色。 |
