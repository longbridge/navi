...
| `bgcolor` | <code>series&nbsp;color</code> | `na` | 表格的背景顏色。 |
| `frame_color` | <code>series&nbsp;color</code> | `na` | 表格的邊框顏色。 |
| `frame_width` | <code>series&nbsp;int</code> | `0` | 框架邊框寬度（以像素為單位）。 |
| `border_color` | <code>series&nbsp;color</code> | `na` | 表格邊框顏色。 |
...
**類型:** <code>series&nbsp;<a class="stdlib-ref" href="/zh-HK/api/stdlib/prelude/Array">Array&lt;<a class="stdlib-ref" href="/zh-HK/api/stdlib/prelude/Table">Table</a>&gt;</a></code>
...
| `bgcolor` | <code>series&nbsp;color</code> | `na` | 單元格的背景顏色。 |
| `tooltip` | <code>series&nbsp;string</code> | `na` | 單元格的工具提示文本。 |
...
| `text_formatting` | <code>const&nbsp;<a class="stdlib-ref" href="/zh-HK/api/stdlib/prelude/TextFormat">TextFormat</a></code> | `text.NONE` | 文本格式選項。 |
...
| `column` | <code>series&nbsp;int</code> |  | 單元格的列索引（從 0 開始）。 |
| `row` | <code>series&nbsp;int</code> |  | 單元格的行索引（從 0 開始）。 |
| `bgcolor` | <code>series&nbsp;color</code> |  | 單元格的新背景顏色。 |
...
| `column` | <code>series&nbsp;int</code> |  | 單元格的列索引（從 0 開始）。 |
| `row` | <code>series&nbsp;int</code> |  | 單元格的行索引（從 0 開始）。 |
| `text` | <code>series&nbsp;string</code> |  | 單元格的新文本內容。 |
...
| `column` | <code>series&nbsp;int</code> |  | 單元格的列索引（從 0 開始）。 |
| `row` | <code>series&nbsp;int</code> |  | 單元格的行索引（從 0 開始）。 |
| `text_color` | <code>series&nbsp;color</code> |  | 單元格的新文本顏色。 |
...
| `column` | <code>series&nbsp;int</code> |  | 單元格的列索引（從 0 開始）。 |
| `row` | <code>series&nbsp;int</code> |  | 單元格的行索引（從 0 開始）。 |
| `text_font_family` | <code>series&nbsp;string</code> |  | 字體系列：FontFamily.Default 或 FontFamily.Monospace。 |
...
| `column` | <code>series&nbsp;int</code> |  | 單元格的列索引（從 0 開始）。 |
| `row` | <code>series&nbsp;int</code> |  | 單元格的行索引（從 0 開始）。 |
| `text_halign` | <code>series&nbsp;string</code> |  | 水平文本對齊方式：TextHAlign.Left、TextHAlign.Center 或 TextHAlign.Right。 |
...
| `column` | <code>series&nbsp;int</code> |  | 單元格的列索引（從 0 開始）。 |
| `row` | <code>series&nbsp;int</code> |  | 單元格的行索引（從 0 開始）。 |
| `text_valign` | <code>series&nbsp;string</code> |  | 垂直文本對齊方式：text.align_top、TextHAlign.Center 或 text.align_bottom。 |
...
| `column` | <code>series&nbsp;int</code> |  | 單元格的列索引（從 0 開始）。 |
| `row` | <code>series&nbsp;int</code> |  | 單元格的行索引（從 0 開始）。 |
| `tooltip` | <code>series&nbsp;string</code> |  | 單元格的新工具提示文本。 |
...
| --- | --- | --- | --- |
| `table_id` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-HK/api/stdlib/prelude/Table">Table</a></code> |  | 要修改的表對象。 |
| `bgcolor` | <code>series&nbsp;color</code> |  | 表格的新背景顏色。 |
...
| --- | --- | --- | --- |
| `table_id` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-HK/api/stdlib/prelude/Table">Table</a></code> |  | 要修改的表對象。 |
| `border_color` | <code>series&nbsp;color</code> |  | 表格的新邊框顏色。 |
...
| --- | --- | --- | --- |
| `table_id` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-HK/api/stdlib/prelude/Table">Table</a></code> |  | 要修改的表對象。 |
| `frame_color` | <code>series&nbsp;color</code> |  | 表格的新框架邊框顏色。 |
