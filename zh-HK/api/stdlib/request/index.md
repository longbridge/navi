...
| 名稱 | 類型 | 預設值 | 說明 |
| --- | --- | --- | --- |
| `from` | <code>series&nbsp;string</code> |  | 源貨幣代碼，例如`\"USD\"` 或 `currency.USD`。 |
| `to` | <code>series&nbsp;string</code> |  | 目標貨幣代碼，例如`\"EUR\"` 或 `currency.EUR`。 |
...
| 名稱 | 類型 | 預設值 | 說明 |
| --- | --- | --- | --- |
| `function` | <code>simple&nbsp;string</code> |  | 要呼叫的 DataProvider 函式名稱。 |
| `args` | <code>series&nbsp;<a class="stdlib-ref" href="/zh-HK/api/stdlib/prelude/Map">Map&lt;string, any&gt;</a></code> | `na` | 傳遞給函式的可選 `map&lt;string, any&gt;` 型別參數。 |
...
| 名稱 | 類型 | 預設值 | 說明 |
| --- | --- | --- | --- |
| `ticker` | <code>series&nbsp;string</code> | `syminfo.tickerid` | 查詢股息的股票；默認為圖表符號。 |
...
| `currency` | <code>series&nbsp;string</code> | `syminfo.currency` | 用於價值轉換的貨幣代碼。 |
...
| 名稱 | 類型 | 預設值 | 說明 |
| --- | --- | --- | --- |
| `ticker` | <code>series&nbsp;string</code> | `syminfo.tickerid` | 查詢收益的股票；默認為圖表符號。 |
...
| 名稱 | 類型 | 預設值 | 說明 |
| --- | --- | --- | --- |
| `country_code` | <code>series&nbsp;string</code> |  | ISO 3166-1 alpha-2 國家/地區代碼，例如__代碼0__，__代碼1__。 |
| `field` | <code>series&nbsp;string</code> |  | 要檢索的經濟指標的標識符。 |
| `gaps` | <code>simple&nbsp;<a class="stdlib-ref" href="/zh-HK/api/stdlib/prelude/BarmergeGaps">BarmergeGaps</a></code> | `BarmergeGaps.Off` | 條形映射模式（請參閲 <a class="stdlib-ref" data-key="prelude::BarmergeGaps" href="/zh-HK/api/stdlib/prelude/BarmergeGaps">BarmergeGaps.Off</a> / <a class="stdlib-ref" data-key="prelude::BarmergeGaps" href="/zh-HK/api/stdlib/prelude/BarmergeGaps">BarmergeGaps.On</a>）。 |
...
| 名稱 | 類型 | 預設值 | 說明 |
| --- | --- | --- | --- |
| `symbol` | <code>series&nbsp;string</code> |  | 要查詢其財務狀況的符號。 |
| `financial_id` | <code>series&nbsp;string</code> |  | 要檢索的財務指標的標識符。 |
| `period` | <code>series&nbsp;string</code> |  | 報告期：`\"FQ`（季度）或`FY\"`（年度）。 |
...
| `currency` | <code>series&nbsp;string</code> | `syminfo.currency` | 用於價值轉換的貨幣代碼；默認為圖表符號的貨幣。 |
...
| 名稱 | 類型 | 預設值 | 說明 |
| --- | --- | --- | --- |
| `symbol` | <code>series&nbsp;string</code> |  | 請求的符號。 |
| `timeframe` | <code>series&nbsp;string</code> |  | 請求的時間範圍字符串，例如 `\"D`、`60` 或 `W\"`。 |
...
| `currency` | <code>series&nbsp;string</code> | `na` | 用於價格轉換的可選貨幣。 |
...
| --- | --- | --- | --- |
| `symbol` | <code>series&nbsp;string</code> |  | 請求的符號。 |
| `timeframe` | <code>series&nbsp;string</code> |  | 較低或等於時間範圍字符串，例如 `\"1` 或 `5\"`。 |
...
**返回:** <code>series&nbsp;<a class="stdlib-ref" href="/zh-HK/api/stdlib/prelude/Array">Array&lt;T&gt;</a></code>
...
| 名稱 | 類型 | 預設值 | 說明 |
| --- | --- | --- | --- |
| `ticker` | <code>series&nbsp;string</code> | `syminfo.tickerid` | 要查詢其拆分的股票代碼；默認為圖表符號。 |
