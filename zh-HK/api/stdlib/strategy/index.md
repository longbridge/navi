...
| 名稱 | 類型 | 預設值 | 說明 |
| --- | --- | --- | --- |
| `id` | <code>series&nbsp;string</code> |  | 要取消的訂單標識符。 |
...
| 名稱 | 類型 | 預設值 | 說明 |
| --- | --- | --- | --- |
| `id` | <code>series&nbsp;string</code> |  | 要關閉的條目 ID。 |
| `comment` | <code>series&nbsp;string</code> | `na` | 生成的平倉訂單的可選註釋。 |
| `qty` | <code>series&nbsp;float</code> | `na` | 絕對數量關閉。 |
| `qty_percent` | <code>series&nbsp;float</code> | `na` | 平倉的百分比。 |
| `alert_message` | <code>series&nbsp;string</code> | `na` | 可選的警報消息。 |
...
| 名稱 | 類型 | 預設值 | 說明 |
| --- | --- | --- | --- |
| `id` | <code>series&nbsp;string</code> |  | 唯一的訂單標識符。 |
...
| `oca_name` | <code>series&nbsp;string</code> | `na` | 可選的“一取消全”組名稱。 |
...
| `comment` | <code>series&nbsp;string</code> | `na` | 可選訂單評論。 |
| `alert_message` | <code>series&nbsp;string</code> | `na` | 此訂單的可選警報消息。 |
...
| 名稱 | 類型 | 預設值 | 說明 |
| --- | --- | --- | --- |
| `id` | <code>series&nbsp;string</code> |  | 唯一的退出指令標識符。 |
| `from_entry` | <code>series&nbsp;string</code> | `na` | 退出的入口 ID。當 `na` 時，退出適用於整個匹配位置。 |
...
| `oca_name` | <code>series&nbsp;string</code> | `na` | 可選的 OCA 組名稱。 |
| `comment` | <code>series&nbsp;string</code> | `na` | 從此出口填充的默認註釋。 |
| `comment_profit` | <code>series&nbsp;string</code> | `na` | 用於止盈填充的註釋。 |
| `comment_loss` | <code>series&nbsp;string</code> | `na` | 用於止損填充的註釋。 |
| `comment_trailing` | <code>series&nbsp;string</code> | `na` | 用於追蹤止損填充的註釋。 |
| `alert_message` | <code>series&nbsp;string</code> | `na` | 默認警報消息。 |
| `alert_profit` | <code>series&nbsp;string</code> | `na` | 用於止盈填充的警報消息。 |
| `alert_loss` | <code>series&nbsp;string</code> | `na` | 用於止損填充的警報消息。 |
| `alert_trailing` | <code>series&nbsp;string</code> | `na` | 用於追蹤止損填充的警報消息。 |
