...
- [變量與限定符](/zh-HK/docs/types-and-variables) — 類型限定符、var/varip、na 處理
- [歷史引用](/zh-HK/docs/history-reference) — 使用 `[]` 存取過去 K 線的值
- [集合](/zh-HK/docs/collections) — array、map、matrix
- [控制結構](/zh-HK/docs/control-structures) — if、for、while、switch
- [函數與方法](/zh-HK/docs/functions-and-methods) — 定義和調用函數
