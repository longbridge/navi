...
### grossloss_percent {#grossloss_percent}
...
### grossprofit_percent {#grossprofit_percent}
...
### netprofit_percent {#netprofit_percent}
...
### openprofit_percent {#openprofit_percent}
...
| --- | --- | --- | --- |
| `id` | <code>series&nbsp;string</code> |  | Order identifier to cancel. |
...
| Name | Type | Default | Description |
| --- | --- | --- | --- |
| `id` | <code>series&nbsp;string</code> |  | Entry ID to close. |
| `comment` | <code>series&nbsp;string</code> | `na` | Optional comment for the generated close order. |
...
| `alert_message` | <code>series&nbsp;string</code> | `na` | Optional alert message. |
...
| Name | Type | Default | Description |
| --- | --- | --- | --- |
| `comment` | <code>series&nbsp;string</code> | `na` | Optional comment for the generated close orders. |
| `alert_message` | <code>series&nbsp;string</code> | `na` | Optional alert message. |
...
| Name | Type | Default | Description |
| --- | --- | --- | --- |
| `id` | <code>series&nbsp;string</code> |  | Unique order identifier. |
...
| `oca_name` | <code>series&nbsp;string</code> | `na` | Optional One-Cancels-All group name. |
...
| `comment` | <code>series&nbsp;string</code> | `na` | Optional order comment. |
| `alert_message` | <code>series&nbsp;string</code> | `na` | Optional alert message for this order. |
...
| Name | Type | Default | Description |
| --- | --- | --- | --- |
| `id` | <code>series&nbsp;string</code> |  | Unique exit-order identifier. |
| `from_entry` | <code>series&nbsp;string</code> | `na` | Entry ID to exit. When `na`, the exit applies to the whole matching position. |
...
| `oca_name` | <code>series&nbsp;string</code> | `na` | Optional OCA group name. |
| `comment` | <code>series&nbsp;string</code> | `na` | Default comment for fills from this exit. |
| `comment_profit` | <code>series&nbsp;string</code> | `na` | Comment used for take-profit fills. |
| `comment_loss` | <code>series&nbsp;string</code> | `na` | Comment used for stop-loss fills. |
| `comment_trailing` | <code>series&nbsp;string</code> | `na` | Comment used for trailing-stop fills. |
| `alert_message` | <code>series&nbsp;string</code> | `na` | Default alert message. |
| `alert_profit` | <code>series&nbsp;string</code> | `na` | Alert message used for take-profit fills. |
| `alert_loss` | <code>series&nbsp;string</code> | `na` | Alert message used for stop-loss fills. |
| `alert_trailing` | <code>series&nbsp;string</code> | `na` | Alert message used for trailing-stop fills. |
