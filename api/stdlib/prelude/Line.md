...
| `color` | <code>series&nbsp;color</code> | `na` | The color of the line. |
...
**Type:** <code>series&nbsp;<a class="stdlib-ref" href="/api/stdlib/prelude/Array">Array&lt;<a class="stdlib-ref" href="/api/stdlib/prelude/Line">Line</a>&gt;</a></code>
...
| `color` | <code>series&nbsp;color</code> |  | The new color of the line. |
