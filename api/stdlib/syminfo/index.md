...
```navi
syminfo.prefix(symbol: string): string
```
...
| --- | --- | --- | --- |
| `symbol` | <code>string</code> |  | The symbol ticker string to get the prefix from. |
...
```navi
syminfo.ticker(symbol: string): string
```
...
| Name | Type | Default | Description |
| --- | --- | --- | --- |
| `symbol` | <code>string</code> |  | The symbol ticker string to get the name from. |
